...
import cn.edu.zucc.manager_home.Manager_HomeStarter;
...
public class FrmAddbuilding extends JDialog implements ActionListener {
	...
	public FrmAddbuilding(JFrame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				Manager_HomeUtil.buildingManager.addBuilding(region,name,buildtype,data,street,developer,ratio,density,park);
				this.setVisible(false);
