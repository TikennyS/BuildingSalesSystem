...
public class FrmAddRegion extends JDialog implements ActionListener {
	...
	public FrmAddRegion(JFrame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			String name=this.edtName.getText();
			 try {
				Manager_HomeUtil.regionManager.addRegion(name);
				this.setVisible(false);
